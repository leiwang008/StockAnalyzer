...
public class SMSClient implements Runnable {
	...
	public static void main(String[] args){
		SMSClient sender = new SMSClient(ASYNCHRONOUS);
		int status = sender.sendMessage("+8613683571910", "a test message from pc.");
		System.out.println("message sent status is "+status);
	}
}