...
public class SerialConnection implements SerialPortEventListener,
	 ...
	 * the port to a closed state, throws a <code>SerialConnectionException</code>, and returns.
	 * 
	...
	public void openConnection() throws SerialConnectionException {
		...
		try {
			if(portId==null){
				System.err.println("Port ID is null, please verify you port name "+parameters.getPortName());
				throw new SerialConnectionException("Port ID is null, please verify you port name "+parameters.getPortName());
			}
...
//				if ( portId.getName().equalsIgnoreCase(parameters.getPortName())){
...
//		}
	...
	class KeyHandler extends KeyAdapter {
		 ...
		 * to an <code>int</code>, writes it to the <code> OutputStream</code> for the
		 * port.
		 */
